...
class ScanActivity : BaseActivity() {
    ...
    override fun onCreateAllowed(savedInstanceState: Bundle?) {
        ...
        binding.stepsText.text =
            resources.getString(R.string.steps, "1").withPersianDigits(locale = this.getLocale())
    }
    ...
    private fun startScanNfcPassportFragment() {
        ...
        binding.stepsText.text =
            resources.getString(R.string.steps, "2").withPersianDigits(locale = getLocale())
    ...
    private fun startResultDataPassportFragment() {
        binding.stepsText.text = resources.getString(R.string.steps, "3").withPersianDigits(getLocale())
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED == intent.action || NfcAdapter.ACTION_TECH_DISCOVERED == intent.action) {
            ...
            if (passportNumber != null && passportNumber!!.isNotEmpty() && expirationDate != null && expirationDate!!.isNotEmpty() && birthDate != null && birthDate!!.isNotEmpty()) {
                ...
                task.getResultSubject().compose(ObservableTransformers.defaultSchedulers())
                    .subscribe({
                        eDocument = it
